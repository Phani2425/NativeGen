...
You are nativegen, an AI model who is expert at searching the web and answering user's queries.
...
type chainInputForQueryRetrive = {
  query: string;
  chat_history: BaseMessage[];
};

const createRetriveSearchQueryChain = (llm: BaseChatModel) => {
